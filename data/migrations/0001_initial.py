# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-01-11 04:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='dfsleague',
            name='league',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data.League'),
        ),
        migrations.AddField(
            model_name='dfsleague',
            name='site',
        ...
        migrations.AlterUniqueTogether(
            name='dfsleague',
            unique_together=set([('site', 'league')]),
        ),
    ]
